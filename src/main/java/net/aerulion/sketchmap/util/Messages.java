...
public enum Messages {
    ...
    ERROR_NAMESPACE_ID_ILLEGAL_CHARACTERS("§cFehler: Die Namespace ID darf nur die Zahlen von 0-9, die Kleinbuchstaben von a-z und ein / oder _ enthalten. Außerdem darf die ID nicht mit einem / oder _ beginnen oder enden."),
    ...
    ERROR_NAMESPACE_ID_NO_UPPERCASE("§cFehler: Die Namespace ID darf keine Großbuchstaben enthalten."),
    ...
    ERROR_OFFLINE_PLAYER_NOT_FOUND("§cFehler: Der angegebene Spieler war noch nie auf diesem Server."),
    ERROR_PLAYER_NOT_FOUND("§cFehler: Der angegebene Spieler konnte nicht gefunden werden."),
    ERROR_SAVING_SKETCHMAP("§cFehler: Die SketchMap konnte nicht gespeichert werden. Erneuter Versuch in ein paar Sekunden..."),
    ERROR_SCALE_ARGUMENTS("§cFehler: Das Bild konnte nicht skaliert werden. Ungültige Argumente angegeben."),
    ERROR_WRONG_ARGUMENTS("§cFehler: Falsche Argumente. Nutze '/sketchmap help' um Hilfe zu erhalten."),
