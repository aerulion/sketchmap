            ...
            for (File file : listOfFiles) {
                if (file.isFile()) {
                    try {
                        ...
                        BufferedImage bufferedImage = Base64Utils.decodeBufferedImage(fileConfiguration.getString("IMAGE"));
                        ...
                        sketchMapID = sketchMapID.replaceAll("ä", "ae");
                        sketchMapID = sketchMapID.replaceAll("ö", "oe");
                        sketchMapID = sketchMapID.replaceAll("ü", "ue");
                        sketchMapID = sketchMapID.replaceAll("ß", "ss");
                        sketchMapID = sketchMapID.replaceAll("-", "_");
