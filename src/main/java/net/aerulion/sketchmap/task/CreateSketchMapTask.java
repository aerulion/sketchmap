...
public class CreateSketchMapTask extends BukkitRunnable {
    ...
    public CreateSketchMapTask(CommandSender COMMANDSENDER, String NAMESPACE_ID, URL IMAGE_URL, int X_PANES, int Y_PANES) {
    ...
    public void run() {
        ...
        Main.LoadedSketchMaps.put(NAMESPACE_ID, new SketchMap(UUID, NAMESPACE_ID, image, X_PANES, Y_PANES, MAPPING));
